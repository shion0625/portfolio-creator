...
export type WorkFragmentFragment = { id: string, title: string, summary?: string | null, image_url?: string | null, duration?: string | null, number_of_people?: number | null, language?: string | null, role?: string | null, url?: string | null, brief_story?: string | null, created_at: any, updated_at: any, number_of_work?: number | null, is_delete: boolean };
 ...
 * });
 */
export function useGetWorkNodesQuery(baseOptions: Apollo.QueryHookOptions<GetWorkNodesQuery, GetWorkNodesQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetWorkNodesQuery, GetWorkNodesQueryVariables>(GetWorkNodesDocument, options);
      }
export function useGetWorkNodesLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetWorkNodesQuery, GetWorkNodesQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
